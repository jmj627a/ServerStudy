...
public:
	...
	/////////////////////////////////////////////////////
	//직렬화 버퍼에 참조 카운트 방식 추가하기
	LONG m_iRefCnt;

	//직렬화 버퍼에 메모리 풀 추가하기
	static CMemoryPool<CPacket> g_PacketPool;
	...
	static void Free(CPacket* pPacket)
	{
		pPacket->Free();
	}

	void AddRefCount(); //refcnt ++
	void Free(); //refcnt --랑 같은 작동
	///////////////////////////////////////////////////////
	...
	void initialize(int iBufferSize = eBUFFER_DEFAULT);
...
protected:
	...
	//버퍼의 읽기 위치, 쓰기 위치
	char*			m_chpReadPos = nullptr;		//head
	char*			m_chpWritePos = nullptr;		//rear
